...
func newRunner(ctx context.Context, rcg *genericclioptions.ConfigFlags) *runner {
	...
	r.Command = &cobra.Command{
		Use:     "restore SOURCE_PACKAGE NAME",
	...
	r.Command.Flags().StringVar(&r.revision, "revision", "", "Revision of the reverted package.")
	return r
}
...
type runner struct {
	...
	restore porchapi.PackageRestoreTaskSpec
...
func (r *runner) preRunE(cmd *cobra.Command, args []string) error {
	...
	r.restore.Source = &porchapi.PackageRevisionRef{
		Name: args[0],
	}
	return nil
}
...
func (r *runner) getPackageRevisionSpec() (*porchapi.PackageRevisionSpec, error) {
	...
	spec.Tasks = []porchapi.Task{{Type: porchapi.TaskTypeRestore, Restore: &r.restore}}
	return spec, nil
}
