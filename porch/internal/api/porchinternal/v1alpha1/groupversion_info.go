...
// +groupName=internal.porch.kpt.dev
package v1alpha1
...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "internal.porch.kpt.dev", Version: "v1alpha1"}

	// We removed SchemeBuilder to keep our dependencies small

	KindRepository = KindInfo{
		Resource: GroupVersion.WithResource("internalpackagerevisions"),
		objects:  []runtime.Object{&InternalPackageRevision{}, &InternalPackageRevisionList{}},
	}
